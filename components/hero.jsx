    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-black to-[#02070D] -mt-24">
      ...
      <div className="flex flex-col items-center justify-center lg:pt-52 pt-20 relative px-4">
        ...
        <div className="relative z-10 max-w-5xl text-center px-4 lg:px-0 lg:mt-0 mt-20">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium text-white my-6 leading-tight">
            Accelerating sales & growth
            <br />
            with our AI solutions.
          </h1>
          <p className="text-[#AAAAAA] mb-8 max-w-lg sm:max-w-xl mx-auto text-sm sm:text-base lg:text-lg">
          ...
          <button className="px-6 py-3 sm:px-8 sm:py-4 rounded-full bg-gradient-to-r from-[#306CF2] to-[#2569F3] text-white font-medium transform hover:scale-105 transition-transform duration-200 hover:shadow-lg hover:shadow-blue-500/25">
